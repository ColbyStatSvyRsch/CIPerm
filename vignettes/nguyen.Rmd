...
The p-values should be `0.07172827` for wing lengths, and `0.002197802` for antennae lengths.
...
The CIs should be around `c(-0.246, 0.01)` for wing lengths, and around `c(0.087, 0.285)` for antennae lengths.
